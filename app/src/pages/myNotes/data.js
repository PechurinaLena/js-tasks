const data = [
  {
    ...
    date: `${new Date(2021, 4, 21, 8, 0).toLocaleTimeString()}`,
  },
  {
    id: 2,
    title: "Morning Yoga",
    ...
    date: `${new Date(2021, 4, 21, 10, 0).toLocaleTimeString()}`,
  },
  {
    id: 3,
    title: "Call meeting",
    ...
    date: `${new Date(2021, 4, 21, 13, 0).toLocaleTimeString()}`,
  },
  {
    id: 4,
    title: "Lunch",
    ...
    date: `${new Date(2021, 4, 21, 14, 30).toLocaleTimeString()}`,
  },
  {
    id: 5,
    title: "Work time",
    ...
    date: `${new Date(2021, 4, 21, 16, 0).toLocaleTimeString()}`,
  },
  {
    id: 6,
    ...
    date: `${new Date(2021, 4, 21, 20, 0).toLocaleTimeString()}`,
  },
  {
    id: 7,
    title: "Relaxing",
    ...
    date: `${new Date(2021, 4, 21, 22, 0).toLocaleTimeString()}`,
  },
];
